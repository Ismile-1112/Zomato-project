...
export default function ReviewModal({isOpen, setIsOpen, ...props}) {
  ...
  const toggleDining = () => setReviewData(prev => ({ ...prev, isFoodReview: false, isRestaurantReview: !reviewData.isRestaurantReview }));
  const toggleDelivery = () => setReviewData(prev => ({ ...prev, isRestaurantReview: false, isFoodReview: !reviewData.isFoodReview }));
                ...
                <div className="mt-2 flex flex-col gap-4">
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2">
                            <input type="radio" name="review" id="dining" checked={reviewData.isRestaurantReview} onChange={toggleDining} />
